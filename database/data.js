...
const products = [
    ...
    {name: "Jabonera", description: "Están hechas con madera de guatambú, palo blanco y protegidas con aceites vegetales. Para que puedas dejar tu shampoo, acondicionador y jabón respirar y secarse bien hasta el próximo uso.", pictureProduct:'/images/products/jaboneraMadera.png', cantComments: 12},
...
const comments = [
    {user: "jorgegomez@gmail.com", comment: "Muy buen producto", pictureProfile: "/images/users/default-image.png"},
    {user: "emiliano1@gmail.com", comment: "Mucho plástico", pictureProfile: "/images/users/default-image.png"},
    {user: "selena@gmail.com", comment: "Me encanto!", pictureProfile: "/images/users/default-image.png"},
    {user: "justinBieber@gmail.com", comment: "A mi novio le gustó", pictureProfile: "/images/users/default-image.png"},
    {user: "camila485@gmail.com", comment: "Un poco caro", pictureProfile: "/images/users/default-image.png"},
    {user: "lucianoRivera@gmail.com", comment: "Me muero antes de pagar estos precios", pictureProfile: "/images/users/default-image.png"},
    {user: "gonzaloGimenez@gmail.com", comment: "Me deja las piernas muy suaves", pictureProfile: "/images/users/default-image.png"},
    {user: "pabloPancho@gmail.com", comment: "safa", pictureProfile: "/images/users/default-image.png"},
];
